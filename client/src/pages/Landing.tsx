...
export default function Landing() {
  ...
  // Automatischer Redirect zum Dashboard für eingeloggte Benutzer
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
        ...
        >
          <div className="flex items-center justify-between h-16">
            ...
            <Link
              ...
              aria-label="Houston - zur Startseite"
            >
              ...
              {isAuthenticated ? (
                <Link href="/app/dashboard">
                  <Button
                    variant="gradient"
                    size="lg"
                    className="text-lg px-10 py-6 shadow-lg shadow-[#FF6B9D]/20"
                  >
      ...
      <section
        id="how-it-works"
        className="relative z-10 section-padding bg-gradient-to-b from-transparent to-black/20"
      >
        <div className="container-premium mx-auto">
        ...
        <div className="container-premium mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
              ...
              <span className="gradient-text-aistronaut">
                {t("landing.forWhom.title.highlight")}
              </span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="glass-card p-4 group hover:scale-[1.02] transition-transform duration-300">
              ...
              <h3 className="text-lg font-semibold text-white mt-4 mb-2">
                {t("landing.screenshots.dashboard.title")}
              </h3>
              <p className="text-white/70 text-sm">
                {t("landing.screenshots.dashboard.description")}
              </p>
            </div>
            ...
            <div className="glass-card p-4 group hover:scale-[1.02] transition-transform duration-300">
              ...
              />
              <h3 className="text-lg font-semibold text-white mt-4 mb-2">
                {t("landing.screenshots.chat.title")}
              </h3>
              <p className="text-white/70 text-sm">
                {t("landing.screenshots.chat.description")}
              </p>
            </div>
            ...
            <div className="glass-card p-4 group hover:scale-[1.02] transition-transform duration-300">
              ...
              />
              <h3 className="text-lg font-semibold text-white mt-4 mb-2">
                {t("landing.screenshots.goals.title")}
              </h3>
              <p className="text-white/70 text-sm">
                {t("landing.screenshots.goals.description")}
              </p>
            </div>
            ...
            <div className="glass-card p-4 group hover:scale-[1.02] transition-transform duration-300">
              <div className="w-full aspect-video rounded-lg bg-gradient-to-br from-[#1a1a2e] to-[#0a0a0f] flex items-center justify-center border border-white/10">
                <div className="text-center p-8">
                  ...
                  <p className="text-white/60 text-sm">
                    {t("landing.screenshots.strategy.title")}
                  </p>
                </div>
              </div>
              <h3 className="text-lg font-semibold text-white mt-4 mb-2">
              ...
              <p className="text-white/70 text-sm">
                {t("landing.screenshots.strategy.description")}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container-premium mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
              ...
              <span className="gradient-text-aistronaut">
                {t("landing.creditsExplained.title.highlight")}
              </span>
            </h2>
            <p className="text-lg text-white/70 max-w-2xl mx-auto">
            ...
            <div className="glass-card p-8">
              ...
              <ul className="space-y-2 text-white/70">
                <li className="flex items-center gap-2">
                  ...
                  {t(
                    "landing.creditsExplained.whatCanYouDo.examples.deepAnalysis",
                  )}
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-green-400 shrink-0" />
                  {t(
                    "landing.creditsExplained.whatCanYouDo.examples.aiInsights",
                  )}
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-green-400 shrink-0" />
                  {t(
                    "landing.creditsExplained.whatCanYouDo.examples.strategyAnalysis",
                  )}
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-green-400 shrink-0" />
                  {t(
                    "landing.creditsExplained.whatCanYouDo.examples.pdfExports",
                  )}
                </li>
              </ul>
            </div>
          ...
          <div className="mt-12 max-w-2xl mx-auto">
            <div className="glass-card overflow-hidden">
              <div className="grid grid-cols-2 gap-px bg-white/10">
                <div className="bg-[#0a0a0f] p-4 font-semibold text-white">
                  {t("landing.creditsExplained.costs.chat")}
                </div>
                <div className="bg-[#0a0a0f] p-4 text-green-400 font-semibold">
                  {t("landing.creditsExplained.costs.chatCost")}
                </div>
                <div className="bg-[#0a0a0f] p-4 text-white/80">
                ...
                <div className="bg-[#0a0a0f] p-4 text-white/80">
                  {t("landing.creditsExplained.costs.pdfExport")}
                </div>
                <div className="bg-[#0a0a0f] p-4 text-white/80">
                  {t("landing.creditsExplained.costs.pdfExportCost")}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="glass-card p-8 hover:scale-105 transition-transform duration-300">
              ...
              <div className="mb-6 p-4 rounded-lg bg-gradient-to-r from-[#FFD489]/10 to-[#8B5CF6]/10 border border-[#FFD489]/20">
                ...
                <p className="text-sm text-white/60">
                  {t("landing.pricing.starter.creditsNote")}
                </p>
              </div>
            ...
            <div className="glass-card p-8 relative border-2 border-[#FF6B9D]/30 hover:scale-105 transition-transform duration-300 shadow-2xl shadow-[#FF6B9D]/10">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-white">
                  {t("landing.pricing.solo.name")}
                </h3>
              </div>
              <div className="mb-6">
                <div className="text-4xl font-bold gradient-text-aistronaut mb-1">
              ...
              <div className="mb-6 p-4 rounded-lg bg-gradient-to-r from-[#FF6B9D]/10 to-[#8B5CF6]/10 border border-[#FF6B9D]/20">
                ...
                <p className="text-sm text-white/60">
                  {t("landing.pricing.solo.creditsNote")}
                </p>
              </div>
              <p className="text-sm text-white/60 mb-4 italic">
                {t("landing.pricing.solo.useCase")}
              </p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-3 text-white/80">
                  <CheckCircle2 className="w-5 h-5 text-green-400 shrink-0" />
            ...
            <div className="glass-card p-8 hover:scale-105 transition-transform duration-300">
              ...
              <div className="mb-6">
                ...
                <p className="text-white/60">
                  {t("landing.pricing.team.period")}
                </p>
              </div>
              <div className="mb-6 p-4 rounded-lg bg-gradient-to-r from-[#00D4FF]/10 to-[#8B5CF6]/10 border border-[#00D4FF]/20">
                <p className="text-xl font-bold text-white mb-1">
                  {t("landing.pricing.team.credits")}
                </p>
                <p className="text-sm text-white/60">
                  {t("landing.pricing.team.creditsNote")}
                </p>
              </div>
              <p className="text-sm text-white/60 mb-4 italic">
                {t("landing.pricing.team.useCase")}
              </p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-3 text-white/80">
                  <CheckCircle2 className="w-5 h-5 text-green-400 shrink-0" />
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <div className="px-4 py-2 rounded-full bg-white/5 border border-white/10">
                <span className="text-white font-semibold">
                  {t("landing.pricing.boosters.small")}
                </span>{" "}
                <span className="text-white/60">
                  {t("landing.pricing.boosters.smallPrice")}
                </span>
              </div>
              <div className="px-4 py-2 rounded-full bg-white/5 border border-white/10">
                <span className="text-white font-semibold">
                  {t("landing.pricing.boosters.medium")}
                </span>{" "}
                <span className="text-white/60">
                  {t("landing.pricing.boosters.mediumPrice")}
                </span>
              </div>
              <div className="px-4 py-2 rounded-full bg-white/5 border border-[#00D4FF]/30">
                <span className="text-white font-semibold">
                  {t("landing.pricing.boosters.large")}
                </span>{" "}
                <span className="text-white/60">
                  {t("landing.pricing.boosters.largePrice")}
                </span>
                <span className="ml-2 text-xs text-[#00D4FF]">
                  {t("landing.pricing.boosters.bestValue")}
                </span>
              </div>
            </div>
          </div>
      ...
      >
        <div className="container-premium mx-auto max-w-4xl">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-white/70">{t("landing.faq.subtitle")}</p>
          </div>
            ...
            {[
              ...
              <details key={key} className="glass-card p-6 group">
                <summary className="flex items-center justify-between cursor-pointer list-none">
                  ...
                  <svg
                    className="w-5 h-5 text-white/60 group-open:rotate-180 transition-transform shrink-0"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
        ...
        <div className="container-premium mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-20">
            ...
            <div className="text-center">
              ...
              <div className="text-sm md:text-base text-white/60">
                {t("landing.stats.marketingGoals")}
              </div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold gradient-text-aistronaut mb-2">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-white/60">
                      {t(`landing.testimonials.testimonial${num}.role`)}
                    </div>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="md:col-span-1">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold gradient-text-aistronaut">
                  Houston
                </span>
              </div>
