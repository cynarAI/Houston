  ...
  variants: {
    variant: {
      ...
      glow: [
        "bg-[var(--glass-bg)] backdrop-blur-xl",
        "border-white/10",
        "shadow-[0_0_20px_rgba(255,107,157,0.2),0_0_30px_rgba(139,92,246,0.15),0_0_40px_rgba(0,212,255,0.1)]",
        "hover:shadow-[0_0_30px_rgba(255,107,157,0.4),0_0_45px_rgba(139,92,246,0.3),0_0_60px_rgba(0,212,255,0.2)]",
        "hover:border-white/20",
      ].join(" "),
      subtle: ["bg-card/50 backdrop-blur-sm", "border-border/50"].join(" "),
    },
  },
  defaultVariants: {
    variant: "default",
