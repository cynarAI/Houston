...
const errorConfig = {
  ...
  server: {
    ...
    message: "Unsere Server sind momentan überlastet. Bitte versuche es in wenigen Minuten erneut.",
  ...
  credits: {
    ...
    message: "Für diese Aktion benötigst du mehr Credits. Lade dein Guthaben auf, um fortzufahren.",
    iconColor: "text-[#ffb606]",
    bgColor: "from-[#ffb606]/20 to-[#442e66]/20",
  },
  notFound: {
    icon: AlertTriangle,
